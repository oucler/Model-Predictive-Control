...
const double ref_espi = 0;
const double ref_v = 100;
// Weight declaration
const double w_cte = 12000;
const double w_epsi = 12000;
 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // the Solver function below.
	  ...
	  // Initialization of fg state and actuators
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  for (int i = a_start; i < n_vars; i++) {
    vars_lowerbound[i] = -maxSpeed;
    vars_upperbound[i] = maxSpeed;
  }
